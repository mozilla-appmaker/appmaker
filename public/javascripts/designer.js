...
define(
  ...
  function($, Ceci, Inflector) {
    ...
    function addComponentCard(component, name, list) {
      ...
      var preview = $('<div class="component-preview"><img src="images/component-screenshots/'+ name + '.png" /><div name='+name+' class="add-component add-component-overlay"><div class="add-tooltip">Click to Add</div></div></div>');
